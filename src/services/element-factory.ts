...
const DATA_TYPE_MAP: Record<string, ElementType> = {
  ...
  'side-title-block': 'container',
  'terms-title': 'terms-title',
  'terms-title-block': 'container',
  'terms-link': 'custom',
  button: 'button',
  'submit-btn': 'button',
  'plan-btn': 'button',
...
const CLASS_MAP: Record<string, ElementType> = {
  ...
  'funnel-subtitle': 'subtitle',
  'funnel-paragraph': 'paragraph',
  'funnel-text-list': 'text-list',
  'funnel-side-title': 'side-title',
  'funnel-terms-title': 'terms-title',
  'funnel-image': 'image',
